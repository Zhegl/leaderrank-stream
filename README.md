...
Каждому треду достается примерно одинаковое количество ребер, с которыми он дальше будет работать (поэтому гипер-узлы не делают один thread>поток узким местом).
